...
{$ENDIF}
	...
	IReplicatedTransaction_insertRecordPtr = function(this: IReplicatedTransaction; name: PAnsiChar; frecord: IReplicatedRecord): Boolean; cdecl;
	...
	IReplicatedTransaction_deleteRecordPtr = function(this: IReplicatedTransaction; name: PAnsiChar; frecord: IReplicatedRecord): Boolean; cdecl;
	...
	IBatchCompletionState = class(IDisposable)
		...
		const NO_MORE_ERRORS = Cardinal(2147483647);
	...
	IReplicatedTransaction = class(IDisposable)
		...
		function insertRecord(name: PAnsiChar; frecord: IReplicatedRecord): Boolean;
		function updateRecord(name: PAnsiChar; orgRecord: IReplicatedRecord; newRecord: IReplicatedRecord): Boolean;
		function deleteRecord(name: PAnsiChar; frecord: IReplicatedRecord): Boolean;
	...
	IReplicatedTransactionImpl = class(IReplicatedTransaction)
		...
		function insertRecord(name: PAnsiChar; frecord: IReplicatedRecord): Boolean; virtual; abstract;
		function updateRecord(name: PAnsiChar; orgRecord: IReplicatedRecord; newRecord: IReplicatedRecord): Boolean; virtual; abstract;
		function deleteRecord(name: PAnsiChar; frecord: IReplicatedRecord): Boolean; virtual; abstract;
...
function IReplicatedTransaction.insertRecord(name: PAnsiChar; frecord: IReplicatedRecord): Boolean;
begin
	Result := ReplicatedTransactionVTable(vTable).insertRecord(Self, name, frecord);
end;
...
function IReplicatedTransaction.deleteRecord(name: PAnsiChar; frecord: IReplicatedRecord): Boolean;
begin
	Result := ReplicatedTransactionVTable(vTable).deleteRecord(Self, name, frecord);
end;
...
function IReplicatedTransactionImpl_insertRecordDispatcher(this: IReplicatedTransaction; name: PAnsiChar; frecord: IReplicatedRecord): Boolean; cdecl;
begin
	try
		Result := IReplicatedTransactionImpl(this).insertRecord(name, frecord);
	except
		on e: Exception do FbException.catchException(nil, e);
	end
end;
...
function IReplicatedTransactionImpl_deleteRecordDispatcher(this: IReplicatedTransaction; name: PAnsiChar; frecord: IReplicatedRecord): Boolean; cdecl;
begin
	try
		Result := IReplicatedTransactionImpl(this).deleteRecord(name, frecord);
	except
		on e: Exception do FbException.catchException(nil, e);
	end
end;
